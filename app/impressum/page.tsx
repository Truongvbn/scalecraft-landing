...
export const metadata: Metadata = {
  title: "Impressum | Scalecraft",
  description: "Impressum und rechtliche Informationen von Scalecraft",
};
  ...
  return (
    <div className="min-h-screen bg-white">
      <main className="max-w-4xl mx-auto px-4 py-16 md:px-8 md:py-24">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-[#252525] mb-8">Impressum</h1>

        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#252525] mb-4">Angaben gemäß § 5 TMG</h2>
            ...
            <p className="text-[#404040] leading-relaxed mt-4">
              <strong>Vertreten durch den Geschäftsführer:</strong> [Name des Geschäftsführers]
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#252525] mb-4">Kontakt</h2>
            <p className="text-[#404040] leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#252525] mb-4">Umsatzsteuer-Identifikationsnummer</h2>
            <p className="text-[#404040] leading-relaxed">
              Umsatzsteuer-Identnr.: [USt-IdNr.]
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#252525] mb-4">Streitschlichtung</h2>
            <p className="text-[#404040] leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#252525] mb-4">Haftung für Inhalte</h2>
            <p className="text-[#404040] leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#252525] mb-4">Haftung für Links</h2>
            <p className="text-[#404040] leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#252525] mb-4">Urheberrecht</h2>
            <p className="text-[#404040] leading-relaxed">
