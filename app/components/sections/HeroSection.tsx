    ...
    <section className="relative w-full overflow-hidden bg-white pb-4 sm:pb-0 lg:pb-4">
      ...
      <div className="relative mx-auto px-4 sm:flex sm:max-h-[630px] sm:justify-center sm:overflow-hidden sm:px-0 lg:block lg:min-h-[750px] lg:max-h-none lg:overflow-visible">
        ...
        >
          ...
          <div className="mt-[94px] flex justify-start sm:mt-[160px] sm:justify-center lg:mt-[150px]"><HeroContent /></div>
          ...
          <div className="mt-[48px] hidden sm:mt-[25px] sm:mb-[25px] sm:flex sm:justify-center lg:mt-[67px] lg:mb-0"><LogoMarquee /></div>
          
          {/* Mobile Marquee - Inside content flow */}
          <div className="mt-[48px] flex w-full justify-center overflow-hidden sm:hidden">
